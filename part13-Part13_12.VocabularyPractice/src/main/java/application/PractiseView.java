...
public class PractiseView {
    ...
    public Parent getView() {
        ...
        addButton.setOnMouseClicked((event) -> {
            ...
            if(dictionary.get(word).toLowerCase().equals(translation.toLowerCase())) {
                feedback.setText("Correct!");
            } else {
                feedback.setText("Incorrect! The translation fo the word is '" + word + "' is '" + dictionary.get(word) + "'.");
                return;
            }
