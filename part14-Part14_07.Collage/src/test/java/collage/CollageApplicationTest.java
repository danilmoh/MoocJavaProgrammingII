...
public class CollageApplicationTest extends ApplicationTest {
    ...
    public void part1() {
        ...
        for (String positionAndColor : part1PixelsExpectedValues()) {
            ...
            fail("Copying to the corner did not work as expected. At position " + arr[0] + ", " + arr[1] + " the value was unexpected., it should be equal to " +
                    "\n"+arr[2] + " or to " + arr[3] + " , but was " + c.toString());
        }
    }
